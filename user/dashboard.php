...
<div class="container mt-5">
    ...
    <i class="bi bi-box-arrow-in-right fs-1"></i>
                            ...
                            <div>
                                <?php if($attendance_today) { ?>
                                    <button class="btn btn-success w-100 disabled" style="opacity: 0.6; cursor: not-allowed;">
                                        <i class="bi bi-check-circle-fill"></i> Sudah Absen Masuk
                                    </button>
                                <?php } else { ?>
                                    <a href="checkin.php" class="btn btn-success w-100 py-2">Absen Masuk</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
    ...
    <i class="bi bi-box-arrow-right fs-1"></i>
                            ...
                            <div>
                                ...
                                if(!$attendance_today) { 
                                ?>
                                    <button class="btn btn-warning w-100 disabled text-white" style="opacity: 0.6; cursor: not-allowed;">
                                        Belum Absen Masuk
                                    </button>
                                <?php 
                                } elseif($attendance_today['check_out']) { 
                                ?>
                                    <button class="btn btn-warning w-100 disabled text-white" style="opacity: 0.6; cursor: not-allowed;">
                                        <i class="bi bi-check-circle-fill"></i> Sudah Absen Pulang
                                    </button>
                                <?php 
                                } else { 
                                ?>
                                    <a href="checkout.php" class="btn btn-warning w-100 py-2 text-white">Absen Pulang</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
